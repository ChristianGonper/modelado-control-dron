...
This folder gathers evaluation artifacts, scenario references, review criteria, and methodological limits.
...
Validation documents explain how results are checked and interpreted.
They should not become the primary home for architecture or theory.
